...
namespace DP\State\ExampleTwo;

use DP\State\ExampleTwo\States\IState;
use DP\State\ExampleTwo\States\OffState;
use DP\State\ExampleTwo\States\OnState;
use DP\State\ExampleTwo\States\BrighterState;
use DP\State\ExampleTwo\States\BrightestState;
